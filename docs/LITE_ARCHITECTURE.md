...
- 判断代码应该放哪、模块边界是否清晰：
  看 [runtime-boundaries](./architecture/runtime-boundaries.md)

- 判断目标目录结构应收敛到哪里：
  看 [target-structure](./architecture/target-structure.md)

- 判断当前阶段 runtime 到底在逼哪些核心能力：
  看 [overview](./architecture/overview.md)
...
- [architecture/target-structure.md](./architecture/target-structure.md)
  最终目标目录结构与各目录职责
