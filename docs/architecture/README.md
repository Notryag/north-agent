...
- [overview.md](D:/workspace/github/north-agent/docs/architecture/overview.md)
  定位、当前阶段目标、核心能力、任务闭环

- [target-structure.md](D:/workspace/github/north-agent/docs/architecture/target-structure.md)
  目标目录结构，以及每个目录未来负责什么

- [runtime-boundaries.md](D:/workspace/github/north-agent/docs/architecture/runtime-boundaries.md)
